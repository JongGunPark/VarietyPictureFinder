...
public class panel_stage2 extends JPanel implements ActionListener  {
   ...
   static int[] imageX = {239, 336, 127, 155};
   static int[] imageY = {318, 243, 226, 269};
   // 틀린부분의 범위 기본 설정값
   ...
   ImageIcon stage2 = new ImageIcon("stage2.png","Stage2");
   JLabel stage11 = new JLabel(stage2);
   
   
   ImageIcon img = new ImageIcon("image3.jpg","Stage1_image1");
   JLabel bg = new JLabel(img);
   
   ImageIcon img2 = new ImageIcon("image4.jpg","Stage1_image2");
...
//      title.setBounds(0, 30, 1000, 30);
      ...
      stage11.setBounds(10, 10, 330, 55);
...
//       }// if end
   ...
   public void paint(Graphics g) {
      ...
      if (h1 == true) {                        // 힌트 동그라미 그리기
         if (f1 == false) {
         g.drawImage(cir2, 230, 360, 60, 60, this);
         g.drawImage(cir2, 710, 360 , 60, 60, this);
         h2=true;
         System.out.println("f1 실행된다.");
            ...
            if(f2 == false && h2 == false) {
               g.drawImage(cir2, 124, 277, 60, 60, this);
               g.drawImage(cir2, 810, 277, 60, 60, this);
               h2=true;
               System.out.println("f2 실행된다.");
               }
            else {
               if(f3 == false && h2 == false) {
                  g.drawImage(cir2, 337, 265, 60, 60, this);
                  g.drawImage(cir2, 600, 265, 60, 60, this);
                  h2=true;
                  ...
                  if(f4 == false && h2 == false) {
                     g.drawImage(cir2, 320, 320, 60, 60, this);
                      g.drawImage(cir2, 630, 320, 60, 60, this);
                      h2=true;
      ...
      if (f1 == true) {
         g.drawImage(cir, 230, 360, 60, 60, this);      //옷
         g.drawImage(cir, 710, 360 , 60, 60, this);
         
      } 
      if (f2 == true) {
         g.drawImage(cir, 124, 277, 60, 60, this);      //전투기
         g.drawImage(cir, 810, 277, 60, 60, this);
         
      }
      if (f3 == true) {
          g.drawImage(cir, 337, 265, 60, 60, this);      //피카츄입
          g.drawImage(cir, 600, 265, 60, 60, this);
          
      }
      if (f4 == true) {
          g.drawImage(cir, 320, 320, 60, 60, this);      //여자머리
          g.drawImage(cir, 630, 320, 60, 60, this);
